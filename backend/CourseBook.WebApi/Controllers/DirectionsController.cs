namespace CourseBook.WebApi.Controllers
{
    ...
    public class DirectionsController : ControllerBase
    {
        ...
        [HttpGet("{facultyId:Guid}/[controller]", Name = nameof(GetFacultyDirection))]
        ...
        [HttpPost("{facultyId:Guid}/[controller]", Name = nameof(CreateDirection))]
        ...
        [HttpPut("[controller]/{directionId:Guid}", Name = nameof(EditDirection))]
        [ProducesResponseType(StatusCodes.Status201Created)]
        ...
        [HttpDelete("[controller]/{directionId:Guid}", Name = nameof(DeleteDirection))]
